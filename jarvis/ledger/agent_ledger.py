...
from jarvis.ledger.chain import (LedgerError, LedgerLocked, TornTail, LedgerWriter,
                                   generate_key, load_private_key, public_key_hex, parse_line)
from jarvis.ledger.verify import verify_file
from jarvis.ledger.anchor import LedgerAnchor

DEFAULT_PATH = "/var/lib/jarvis/ledger.jsonl"
DEFAULT_KEY = "/etc/jarvis/ledger/ed25519.key"
DEFAULT_PUB = "/etc/jarvis/ledger/ed25519.pub"
...
class AgentLedger:
    def __init__(self, config: Optional[dict], logger, writer: str = "jarvis",
